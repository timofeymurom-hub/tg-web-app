...
const PUBMED_ARTICLES = [
  ...
  {
    category: "training",
    title: "🏋️ Диапазон повторений и гипертрофия (Легкие vs Тяжелые веса)",
    summary: "Рост мышц одинаков как при работе с тяжелыми весами (3-5 повторений), так и с легкими (до 30 повторений), если сеты выполняются близко к отказу.",
    study: "Schoenfeld BJ et al. (2017) | PMID: 28834797",
    details: "При одинаковом объеме и близости к отказу, легкие веса требуют больше подходов к отказу, но дают ту же гипертрофию, что и тяжелые, хотя тяжелые лучше растят силу."
  },
  {
    category: "training",
    title: "📏 Полная амплитуда движений (Full ROM vs Partial ROM)",
    summary: "Тренировки с полной амплитудой движения более эффективны для гипертрофии и силы, особенно когда мышца нагружается в растянутом состоянии.",
    study: "Pedrosa GF et al. (2020) | PMID: 32030125",
    details: "Сравнение показало, что нагрузка в растянутой амплитуде дает больший прирост толщины мышц, чем тренировки в укороченной части амплитуды."
  },
  {
    category: "training",
    title: "🧠 Связь «Мозг-Мышцы» (Mind-Muscle Connection)",
    summary: "Сознательное фокусирование внимания на сокращении целевой мышцы во время упражнения увеличивает её мышечную активацию и рост.",
    study: "Schoenfeld BJ et al. (2018) | PMID: 29533715",
    details: "Группа, концентрировавшаяся на сокращении бицепса, получила в 2 раза большую гипертрофию по сравнению с группой, которая просто думала о поднятии веса."
  },
  {
    category: "training",
    title: "⏱ Темп выполнения упражнений (Скорость повторения)",
    summary: "Скорость выполнения одного повторения от 0.5 до 8 секунд дает одинаковую гипертрофию. Сверхмедленный темп (>10 секунд) малоэффективен.",
    study: "Schoenfeld BJ et al. (2015) | PMID: 25601394",
    details: "Мета-анализ показал, что намеренное замедление повторения свыше 8-10 секунд снижает мышечную активацию и не способствует лучшему росту мышц."
  },
  {
    category: "training",
    title: "📈 Периодизация тренировок: Линейная против волновой",
    summary: "Волнообразная периодизация (изменение весов и повторений каждую тренировку) эффективнее для роста силы, чем классическая линейная схема.",
    study: "Williams TD et al. (2017) | PMID: 28863175",
    details: "Анализ подтвердил, что частая смена тренировочного стимула (DUP) создает меньшую адаптацию и более быстрый прогресс в силе у подготовленных атлетов."
  },
  ...
  },
  {
    ...
    summary: "Для максимального анаболического ответа рекомендуется делить суточный белок на 4 равных приема пищи с интервалом в 3-5 часов.",
    study: "Schoenfeld BJ & Aragon AA (2018) | PMID: 29497353",
    details: "Оптимальная доза за один прием составляет 0.40 - 0.55 г белка на кг веса тела. Большие дозы окисляются или используются как энергия."
  },
  {
    category: "nutrition",
    title: "🔄 Диетические перерывы: Исследование MATADOR",
    summary: "Периодические перерывы в диете (2 недели дефицита чередуются с 2 неделями поддержки) помогают сохранить скорость метаболизма при похудении.",
    study: "Byrne NM et al. (2018) | PMID: 29117865",
    details: "Участники на циклической диете потеряли на 50% больше жира и лучше сохранили энергообмен в покое по сравнению с непрерывной диетой."
  },
  {
    category: "nutrition",
    title: "🥩 Кето-диета в силовом спорте",
    summary: "Низкоуглеводная кетогенная диета эффективна для сжигания жира, но не является оптимальной для набора сухой мышечной массы.",
    study: "Vargas S et al. (2020) | PMID: 32001550",
    details: "После 8 недель тренировок группа на кето потеряла жир, но не набрала мышц, в отличие от группы на углеводах, показавшей значительный мышечный рост."
  },
  {
    category: "nutrition",
    title: "🍰 Размер профицита калорий для набора мышц",
    summary: "Небольшой профицит калорий (300-500 ккал) растит мышцы так же эффективно, как и агрессивный профицит, но без избыточного отложения жира.",
    study: "Ribeiro AS et al. (2019) | PMID: 30707135",
    details: "Агрессивный профицит привел к набору жировой массы в 3 раза больше без существенной разницы в приросте силы или мышечных объемов."
  },
  {
    category: "nutrition",
    title: "⏰ Интервальное голодание (Skipping Breakfast)",
    summary: "Пропуск завтрака и сокращение окна питания помогают уменьшить потребление калорий, но не имеют метаболического преимущества для сжигания жира.",
    study: "Tempest M et al. (2019) | PMID: 31407147",
    details: "При одинаковом суточном дефиците калорий интервальное голодание 16/8 показало те же результаты по жиросжиганию, что и классическое дробное питание."
  },

  // ── ДОБАВКИ ──
  {
    category: "supplements",
    title: "💊 Креатин моногидрат: Сила и мышечная масса",
    summary: "Самая научно доказанная добавка в спорте. Ускоряет ресинтез АТФ, повышает силовые показатели и увеличивает объем клеток (гидратацию).",
    study: "Kreider RB et al. (2003) | PMID: 14636102",
    details: "Сотни исследований показывают прирост максимальной силы на 5-15% и сухой массы тела на 1-2 кг уже за первые недели приема."
  },
  {
    category: "supplements",
    title: "☕ Кофеин: Выносливость и снижение RPE",
    summary: "Кофеин повышает работоспособность, увеличивает рекрутирование мышечных волокон и притупляет ощущение тяжести тренировки.",
    study: "Astorino TA et al. (2010) | PMID: 20029278",
    details: "Прием 3-6 мг кофеина на кг массы тела за 60 минут до тренировки увеличивает одноповторный максимум и объем выполненной работы."
  },
  {
    category: "supplements",
    title: "🍉 Цитруллин малат против мышечного утомления",
    summary: "Донатор азота. Увеличивает кровоток в мышцах (пампинг), ускоряет выведение аммиака и лактата, снижая боль в мышцах после тренировки.",
  ...
  {
    category: "supplements",
    title: "🥩 Сывороточный протеин против соевого и казеина",
    summary: "Быстро усваиваемый сывороточный протеин сильнее стимулирует синтез мышечного белка после силовой тренировки, чем медленный казеин или соя.",
    study: "Tang JE et al. (2009) | PMID: 19589961",
    details: "Сывороточный протеин показал синтез белка на 93% выше, чем соевый, и на 18% выше, чем казеин, из-за более высокой концентрации лейцина."
  },
  {
    category: "supplements",
    title: "🐟 Жирные кислоты Омега-3 и синтез белка",
    summary: "Омега-3 кислоты не только снимают воспаление, но и усиливают анаболический отклик на прием аминокислот и инсулина.",
    study: "Smith GI et al. (2011) | PMID: 21159787",
    details: "Регулярный прием омега-3 в течение 8 недель увеличивал активность сигнального пути mTOR и скорость синтеза белка у здоровых взрослых."
  },
  {
    category: "supplements",
    title: "☀️ Витамин D и сила скелетных мышц",
    summary: "Дефицит витамина D напрямую связан со снижением силы и атрофией мышечных волокон типа II. Добавка возвращает силу.",
    study: "Carrillo AE et al. (2013) | PMID: 27379691",
    details: "Спортсмены, принимавшие витамин D при его начальном дефиците, показали значительный прирост взрывной силы ног и улучшение состава тела."
  },
  ...
  {
    category: "recovery",
    title: "❄️ Ледяные ванны после тренировки блокируют рост мышц!",
    summary: "Охлаждение мышц холодной водой сразу после силовой тренировки подавляет воспалительный процесс, необходимый для гипертрофии.",
    study: "Roberts LA et al. (2015) | PMID: 26174323",
    details: "Ледяная ванна (10°C) привела к снижению накопления мышечного белка и заметному подавлению долгосрочного роста мышечных объемов и силы."
  },
  {
    category: "recovery",
    title: "🧘 Роль миофасциального релиза (Foam Rolling)",
    summary: "Прокатка на массажном валике (МФР) после тренировок снижает интенсивность отложенной мышечной боли (крепатуры) и ускоряет восстановление силы.",
    study: "Pearcey GE et al. (2015) | PMID: 25432427",
    details: "Использование Foam Roller после приседаний значительно уменьшило боль в мышцах на 24-72 часа и улучшило показатели прыжка и скорости восстановления."
  },
  {
    category: "recovery",
    title: "🧠 Психологический стресс замедляет восстановление силы",
    summary: "Высокий уровень ментального стресса в жизни замедляет восстановление мышц после физических нагрузок в несколько раз.",
    study: "Stults-Kolehmainen MA et al. (2014) | PMID: 24345715",
    details: "Атлетам с высоким уровнем стресса требовалось до 96 часов на полное восстановление мышечной силы, тогда как группа с низким стрессом восстанавливалась за 24 часа."
  },
  {
    category: "recovery",
